...
#  Victor Klimov: Работал программистом 1С некоторое время.
#  И эта задача сильно напомнила то, как создается структура документов, справочников
#  и прочих объектов конфигурации 1С. Модели баз данных, наверно, тоже похоже создаются.
#  Забавно;)
